...
dataTest = '../data/' + args['-dataTest'] + '.pkl.gz'
seq_model = args['-seqM']
...
train_t, train_d, train_y, valid_t, valid_d, valid_y, _, _, _ = prepare_data.load(dataset)
_, _, _, _, _, _, test_t, test_d, test_y = prepare_data.load(dataTest)
...
his = model.fit([train_t, train_tmask, train_d, train_dmask], train_y,
                ...
                nb_epoch=50, batch_size=100, callbacks=callbacks)